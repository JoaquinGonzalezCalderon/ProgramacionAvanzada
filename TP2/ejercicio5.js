...
const mayores = paquetesDatos.filter(paq => paq.tamaño >1000);

const orden = mayores.sort ((a,b) => a.prioridad - b.prioridad)

console.log("Paquetes mayores a 1000 bytes: " ,orden)